...
def generate_launch_description():
    ...
    # Path to our custom navigation parameters
    nav2_params_path = os.path.join(custom_bt_dir, 'config', 'nav2_params.yaml')
    ...
    # Nav2 launch with custom waypoint navigation (delayed to allow SLAM to start)
